...
public class Log_In extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        btnReset = (Button) findViewById(R.id.forget_pass);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Log_In.this, Reset_Password.class));
            }
        });
                        ...
                        .addOnCompleteListener(Log_In.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                   ...
                                   Intent intent = new Intent(Log_In.this, Channel.class);
